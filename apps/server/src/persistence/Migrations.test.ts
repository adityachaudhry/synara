  ...
  it.effect("keeps a private database that already recorded old migration 54 compatible", () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(executed, [
        ...
        [97, "ProjectionProjectsRepositoryBinding"],
        [98, "WorkspaceCreationIntents"],
      ]);
      ...
      assert.deepStrictEqual(tracker.slice(-44), [
        ...
        { migration_id: 97, name: "ProjectionProjectsRepositoryBinding" },
        { migration_id: 98, name: "WorkspaceCreationIntents" },
      ]);
