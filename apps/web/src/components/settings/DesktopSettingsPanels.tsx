  ...
  return (
    <div className="space-y-6">
      <SettingsCard divided={false} className="flex items-start gap-3 px-4 py-3.5">
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className={SETTINGS_CARD_ROW_DESCRIPTION_CLASS_NAME}>
            Press your two-key shortcut while any app is frontmost. Glasswing AI captures that window as
      ...
      <SettingsSection title="Capture">
        ...
        <SettingsRow
          title="Shortcut"
          description="Choose exactly two keys: one modifier and one other key. Glasswing AI checks its own bindings and asks macOS whether another app already owns the shortcut before saving it."
          control={
