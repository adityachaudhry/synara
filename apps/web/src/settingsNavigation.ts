...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    description: "Every keyboard shortcut available in Glasswing AI, grouped by context.",
    icon: "shortcut",
  ...
  },
  {
    ...
    group: "app",
    label: "Worktrees",
    description: "Review and clean up the worktrees created by Glasswing AI.",
    icon: "branch-simple",
