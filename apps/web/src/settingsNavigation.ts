...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how Glasswing AI tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other local agents scoped access to Glasswing AI tasks.",
    icon: "plugin-1",
  ...
  },
  {
    ...
    description: "Review and clean up isolated workspaces created by Glasswing AI.",
    icon: "branch-simple",
