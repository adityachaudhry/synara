...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  // ── Keyboard Shortcuts ────────────────────────────────────────────────────────
  {
    ...
    keywords:
      "Every keyboard shortcut available in Glasswing AI, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Glasswing AI. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Glasswing AI can safely update. upgrade cli",
  },
  {
