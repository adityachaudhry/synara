...
export const WsProviderPrepareThreadRpc = Rpc.make(WS_METHODS.providerPrepareThread, {
  payload: ProviderPrepareThreadInput,
  success: ProviderPrepareThreadResult,
  error: WsRpcError,
});
